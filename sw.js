const CACHE='mi-pauta-v3.0.0';
const CORE=['./','./index.html','./styles.css?v=3.0.0','./core.js?v=3.0.0','./app.js?v=3.0.0','./manifest.webmanifest','./icon.svg','./icon-192.png','./apple-touch-icon.png'];
